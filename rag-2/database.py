...
def init_db():
    ...
    cursor.executescript('''
        ...
        -- + embedding column for vector representations
    ...
    # Migration: add embedding column if it doesn't exist (for older databases)
    try:
        conn.execute('ALTER TABLE DOCUMENT_SECTION ADD COLUMN embedding BLOB')
        conn.commit()
    except Exception:
